  ...
  const SECTIONS = [
    ...
    // ----------------- HAND RANKINGS
    {
      ...
      body: `
        ...
        <ol>
          <li><b>High Card (کارت بالا)</b> — هیچ ترکیبی ساخته نشده؛ فقط بالاترین کارت تعیین‌کننده است. مثال: A♠ 9♦ 7♣ 4♥ 2♣</li>

<li><b>One Pair (یک جفت)</b> — دو کارت هم‌ارزش. مثال: K♠ K♦ 8♣ 5♥ 2♦</li>

<li><b>Two Pair (دو جفت)</b> — دو جفت متفاوت. مثال: Q♠ Q♦ 7♣ 7♥ 3♠</li>

<li><b>Three of a Kind / Trips (سه‌تایی)</b> — سه کارت هم‌ارزش. مثال: J♠ J♦ J♣ 9♥ 4♦</li>

<li><b>Straight (استریت)</b> — پنج کارت پشت‌سرهم با خال متفاوت. مثال: 5♠ 6♦ 7♣ 8♥ 9♠</li>

<li><b>Flush (فلاش)</b> — پنج کارت هم‌خال بدون ترتیب خاص. مثال: 2♥ 6♥ 9♥ J♥ K♥</li>

<li><b>Full House (فول هاوس)</b> — یک سه‌تایی + یک جفت. مثال: 10♠ 10♦ 10♣ 4♥ 4♠</li>

<li><b>Four of a Kind / Quads (چهارتایی)</b> — چهار کارت هم‌ارزش. مثال: 8♠ 8♦ 8♣ 8♥ K♠</li>

<li><b>Straight Flush (استریت فلاش)</b> — استریت + هم‌خال. مثال: 5♥ 6♥ 7♥ 8♥ 9♥</li>

<li><b>Royal Flush (رویال فلاش)</b> — قوی‌ترین دست پوکر؛ 10 تا آس هم‌خال. مثال: 10♠ J♠ Q♠ K♠ A♠</li>
        </ol>
